...
function CallToAction(){
  ...
  return(
    <div className={''}>
      <AnimatedDiv className={'CTA min-h-[380px] sm:min-h-[300px]  relative w-[100%] flex flex-row items-center justify-center bg-transparent'} childern={<CallToActionContent/>}/>
    </div>
  )
}
  ...
  return (
        <div className='ctaBody absolute -top-16 w-[90%] sm:w-[80%] bg-green-200 flex flex-col sm:flex-row items-center justify-center content-stretch'>
            <div className='bg-transparent p-4 sm:p-8 w-[100%] sm:w-[50%] h-[100%]'>
                ...
                <a className='text-[1rem] py-2 cursor-pointer underline text-green-600 hover:text-green-800 transition-all ease-in duration-500'>Email Senden</a>
            </div>
            <div className='bg-green-400 p-4 sm:p-8 w-[100%] sm:w-[50%]'>
                ...
                <a className='text-[1rem] py-2 cursor-pointer underline text-green-600 hover:text-green-800 transition-all ease-in duration-500'>Jetzt Anrufen!</a>
            </div>
        </div>
  )
}
